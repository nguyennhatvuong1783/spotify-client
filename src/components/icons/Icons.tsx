...
export function ChatAlt(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            {...props}
        >
            <circle cx="19" cy="3" r="3" fill="currentColor"></circle>
            <path
                fill="currentColor"
                d="M6 8V6h9.03a4.9 4.9 0 0 1-.92-4H4.01a2 2 0 0 0-2 2L2 22l4-4h14c1.1 0 2-.9 2-2V6.97C21.16 7.61 20.13 8 19 8zm8 6H6v-2h8zm4-3H6V9h12z"
            ></path>
        </svg>
    );
}

export function OpenChat(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            data-encore-id="icon"
            role="img"
...
export function RepeatOne(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            data-encore-id="icon"
            role="img"
        ...
        >
            ...
            ></path>
            <path fill="currentColor" d="M8.77 2.544 8 1.85v.693h.77Z"></path>
        </svg>
    );
}
